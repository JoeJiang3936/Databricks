...
-- MAGIC ```
-- MAGIC 
-- MAGIC    THIS IS AN EXAMINATION OF SQL COMMANDS VIA A SPARK SQL NOTEBOOK
-- MAGIC    
-- MAGIC    PLATFORM:  DATABRICKS
-- MAGIC    
-- MAGIC    PURPOSE:   Walking thru the command structure for some examples
-- MAGIC    
-- MAGIC ```

-- COMMAND ----------

-- this is an example comment in SQL
-- this IS a SQL apache spark notebook ! 
