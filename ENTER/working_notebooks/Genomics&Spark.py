...
# MAGIC %md
# MAGIC ## More Genomics on Python / Databricks
...
# where is your hail jar located ? 
# here:
...
# find the jars you have to work with ...
...
# MAGIC 
# MAGIC ### Cbp data
# MAGIC subset of 1% from my unpublished genomic data on [*Capsella bursa-pastoris*](https://en.wikipedia.org/wiki/Capsella_bursa-pastoris) (hereafter Cbp).
# MAGIC 
# MAGIC ### Human data
# MAGIC 
...
vds = hc.import_vcf(vcf_path) # bgz import fails even with force_bgz=True. 
# bgzip from https://github.com/samtools/tabix 
